...
namespace PServer_v2.NetWork.DataExt
{
    public class Veichle
    {
        ...
        public ushort dmg;
        public ushort HP;
        List<cCharacter> PassengersList = new List<cCharacter>();
        public List<cCharacter> Passengers { get { return PassengersList; } }
        cGlobals globals;
        ...
        public Veichle(cGlobals g)
        {
            globals = g;
        }
        public void DriverGetin(cCharacter t)
        {
            owner = t;
            FuelGuage();
        }
        public void AddPassenger(cCharacter t)
        {
            PassengersList.Add(t);
        }
        public void RemPassenger(cCharacter t,bool All)
        {
            if (t == owner)
                owner = null;
            if (All)
   ...
   public class TransportationManager
    {
       ...
       public TransportationManager(cCharacter y,cGlobals i)
       {
           own = y; globals = i;
       }
       ...
       {           
           ...
           veh.AddWord(y.ID);
           veh.SetSize();
           own.map.SendtoCharactersEx(veh, own);
